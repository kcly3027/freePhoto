<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adlist.aspx.cs" Inherits="freePhoto.Web.Admin.User.adlist" %>
                ...
                <div class="navbar-inner">
                    ...
                    <form class="navbar-form pull-left" id="form1" method="post" action="printPhoto.aspx?p=1">
                        ...
                        <select name="type" id="type" class="span4">
                            ...
                            <option value="已完成"<% if (OType == "已完成") {%> selected="selected"<%} %>>已完成</option>
                        </select>
                ...
                <asp:Repeater runat="server" ID="Repeater1">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="adorderinfo.aspx?o=<%# Eval("OrderNo") %>" class="btn">查看</a>
                        </td>
                    </tr>
                    </ItemTemplate>
                </asp:Repeater>
