...
namespace freePhoto.Web
{
    public partial class orders : PageBase
    {
        ...
        private DataTable Bind1()
        {
            ...
            return OrderDAL.GetOrderList(CurrentUser.UserID, OrderNo, "", (Int64)p1, PSize, out Record1);
        }
        ...
        private DataTable Bind2()
        {
            ...
            return OrderDAL.GetOrderList(CurrentUser.UserID, OrderNo, "未付款", (Int64)p2, PSize, out Record2);
        }
        ...
        private DataTable Bind3()
        {
            ...
            return OrderDAL.GetOrderList(CurrentUser.UserID, OrderNo, "已付款", (Int64)p3, PSize, out Record3);
        }
