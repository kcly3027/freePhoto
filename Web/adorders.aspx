<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adorders.aspx.cs" Inherits="freePhoto.Web.adorders" %>
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="div1">
                ...
                <script type="text/javascript">
                    function GetP1(p) {
                        var o = $("#orderno").val();
                        $.get("adorders.aspx?action=getp1", { p1: p,o:o }, function (html) {
                            if(html != ""){
            ...
            <div class="tab-pane" id="div2">
                ...
                <script type="text/javascript">
                    function GetP2(p) {
                        var o = $("#orderno").val();
                        $.get("adorders.aspx?action=getp2", { p2: p, o:o }, function (html) {
                            if(html != ""){
            ...
            <div class="tab-pane" id="div3">
                ...
                <script type="text/javascript">
                    function GetP3(p) {
                        var o = $("#orderno").val();
                        $.get("adorders.aspx?action=getp3", { p3: p, o: o }, function (html) {
                            if(html != ""){
